# ------------------------------------------------------------------------
# Modified from DiffusionDrive(https://github.com/hustvl/DiffusionDrive)
...
class CustomTransformerDecoderLayer(nn.Module):
    ...
    def forward(self, 
        ...
        # ego_query is the planning token outputed by LLM
        # traj_feautre is fully conditioned on ego_query

...
# 方法1：直接使用官方方法调用llava3模型
# from transformers import AutoModelForCausalLM, AutoTokenizer
# import torch

# model_id = "llava/llava-3-8b"  # LLAVA3 Hugging Face repo
...
class LlavaLlama3ForCausalLM(LlavaMetaForCausalLM, LlamaForCausalLM):
    config_class = Llava3Config
...
AutoConfig.register("llava3_llama", Llava3Config)

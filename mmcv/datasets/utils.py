...
from mmcv.datasets.pipelines import (PETRFormatBundle3D,
                                        LoadAnnotations3D,
                                        MultiScaleFlipAug3D)

from mmcv.datasets.builder import PIPELINES
from mmcv.datasets.pipelines import LoadAnnotations, LoadMultiViewImageFromFilesInCeph
...
def is_loading_function(transform):
    ...
    loading_functions = (LoadAnnotations3D, LoadMultiViewImageFromFilesInCeph,
                         PETRFormatBundle3D)

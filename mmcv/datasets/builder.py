...
from .samplers import DistributedGroupSampler, DistributedSampler, GroupSampler, InfiniteGroupEachSampleInBatchSampler
...
def build_dataloader(dataset,
    ...
    if runner_type['type'] == 'IterBasedRunner' and shuffler_sampler['type'] =='InfiniteGroupEachSampleInBatchSampler':
        ...
        sampler_kwargs = shuffler_sampler.copy()
        sampler_kwargs.pop('type', None)

...
from mmcv.utils.misc import load_model,load_model3
...
class CoT(MVXTwoStageDetector):
    def __init__(self,
        ...
        super(CoT, self).__init__(pts_voxel_layer, pts_voxel_encoder,
        ...
        if lm_head is not None:
            ...
            self.lm_head = load_model3(lm_head, use_lora, frozen, lm_kwargs, fp16_infer) #CoT4AD调用LLaMa3
        if use_gen_token:
